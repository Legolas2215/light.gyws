...
<head>
    ...
    <link href="img/light_logo%20(1).png" rel="icon">
    ...
    <link href="lib/lightbox/css/lightbox.min.css" rel="stylesheet"><!-- css files used-->
...
<br>
                    ...
                    <div class="bb-custom-wrapper">
                        <div id="bb-bookblock" class="bb-bookblock">
                            <div class="bb-item cover">
                                <div style=" height: 100%; overflow: hidden;" class="container-fluid">
                                    <div style="height: 100%;" class="row">
                                        ...
                                        <div class="col-6"><img src="img/network/bookblock/ram1.png" style="margin-top: 10px;">
                            ...
                            <div class="bb-item">
                                <div style=" height: 100%; overflow: hidden;" class="container-fluid">
                                    <div class="row">
                                        <div class="col-6"><img src="img/network/bookblock/ram2.png" style="margin-top: 10px;">
    ...
    <div id="how_we_can_help" class="container text-center my-3">
        ...
        <div class="row mx-auto my-auto">
            <div id="recipeCarousel" data-ride="carousel" class="carousel slide w-100">
                ...
                <div class="col-md-4 wow fadeInUp">
                    <div class="about-col">
                        ...
                        <p style="font-size: 16px;">We always believe that building a forest is much better than
                            ...
                            workers</p><a href="worker.php"><button style="margin-left: 20px;"><strong style="color:#e6c525;">Read more</strong></button></a><br><br>
                    </div>
                </div>
                <div data-wow-delay="0.1s" class="col-md-4 wow fadeInUp">
                    <div class="about-col">
                        ...
                        <p style="font-size: 16px;">College Students like Ram, <br> a) Who instead of blaming
                            governments wants...</p><a href="student.php"><button style="margin-left: 20px;"><strong style="color:#e6c525;">Read more</strong></button></a><br><br>
                    </div>
                </div>
                <div data-wow-delay="0.2s" class="col-md-4 wow fadeInUp">
                    <div class="about-col">
                        ...
                        <p style="font-size: 16px;">If you are a College Professor, <br> a) who thinks that your
                            students should get opertunity...</p><a href="professor.php"><button style="margin-left: 20px;"><strong style="color:#e6c525;">Read
    ...
    <div style=" justify-content: center;" class="row">
        ...
        <div class="rajrow">
            <div class="rajcolumn">
                <div class="rajcard wow fadeInUp">
                    <p>1. By joining LiGHT, he will become a part of a network which is spread nationwide across 12 states.
        ...
        <div id="difference" style="margin-top: 80px;" class="container-fluid">
            <div class="row justify-content-center">
                    ...
                    <div class="container mt-4">
                        <div class="row">
                            ...
                            <div style="margin: auto;" class="col-md-6 student-run">
                                <p style="color: white;" class="wow fadeInUp">Student-run: The complete <b style="color: #e6c525;">LiGHT</b> network is run by students studying in different
                ...
                <!--<div class="bg-light col-lg-6" style="padding: 30px;">
...
ACTIVE MEMBERS<br><br>
        ...
        <div style="padding: 40px" class="container-fluid bg-light">
                    ...
                    <div style="margin-bottom: 20px;" class="col-lg-4 col-md-6 col-12 wow fadeInUp">
                        <div class="my-card">
                            <div class="my-card-inner">
                                ...
                                <div class="card-back">
                                    <p id="p3">We are a network of under-graduate, Post Graduates and Research Scholars
                    ...
                    <div style="margin-bottom: 20px;" class="col-lg-4 col-md-6 col-12 wow fadeInUp">
                        <div class="my-card">
                            <div class="my-card-inner">
                                ...
                                <div class="card-back">
                                    <p id="p2">Not only for career, members in LiGHT are always ready to help you in various
                    ...
                    <div style="margin-bottom: 20px;" class="col-lg-4 col-md-6 col-12 wow fadeInUp">
                        <div class="my-card">
                            <div class="my-card-inner">
                                ...
                                <div class="card-back">
                                    <p id="p1">In GYWS and LiGHT, members have completed or are doing various
