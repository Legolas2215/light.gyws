...
<body>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 xs-padding">
                        <div class="promo-content">
                            ...
                            <h3>Our Mission</h3>
                            <p style="text-align: justify;">LiGHT exist to deliver Gopali Youth Welfare Society's learnings, expertise & experience to involve Youth in social problem solving to the youth throughout the nation.</p>
                            <!-- <a href="#">Read More</a> -->
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 xs-padding">
                        <div class="promo-content">
                            ...
                            <h3>Our Plan</h3>
                            <p style="text-align: justify;">We plan to involve our centers into the end-to-end development of a nation-wide social intiative for the initial period, with an aim to empower them with the required skills and mindset to identify problems in their own locality and design social initiatives as they mature.</p>
                            <!-- <a href="#">Read More</a> -->
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6 xs-padding">
            ...
            <div id="event-carousel" class="events-wrap owl-Carousel">
                <div class="events-item">
                    <div class="event-thumb">
                        <img src="gopali-img/rise.jpg" alt="events" style="height: 400px;">
                    </div>
                ...
                <div class="events-item">
                    <div class="event-thumb">
                        <img src="gopali-img/ccp.jpg" alt="events" style="height: 400px;">
                    </div>
                    <div class="event-details">
                ...
                <div class="events-item">
                    <div class="event-thumb">
                        <img src="gopali-img/cleanliness.jpg" style="height: 400px;">
                    </div>
                    <div class="event-details">
                        ...
                        <p>Cleanliness Drive was a nationwide event at various centres aimed to mark the launch of Swachh Bharat Mission from LiGHT</p>
                        <!-- <a href="#" class="default-btn">Read More</a> -->
                    </div>
                </div><!-- Event-3 -->
                <div class="events-item">
                    <div class="event-thumb">
                        <img src="gopali-img/sindrievent.jpg" style="height: 400px;">
                    </div>
                    <div class="event-details">
                        <strong>LiGHT Sindri Event</strong>
                ...
                <div class="events-item">
                    <div class="event-thumb">
                        <img src="gopali-img/Wardha.jpg" style="height: 400px;">
                    </div>
                    <div class="event-details">
                        <strong>LiGHT Wardha Event </strong>
                ...
                <div class="events-item">
                    <div class="event-thumb">
                        <img src="gopali-img/Raipur.jpg" style="height: 400px;">
                    </div>
                    <div class="event-details">
                        <strong>LiGHT Raipur Event</strong>
                ...
                <div class="events-item">
                    <div class="event-thumb">
                        <img src="gopali-img/Samvedna.jpg" style="height: 400px;">
                    </div>
                    <div class="event-details">
                        <strong>LiGHT Samvedna Event</strong>
                ...
                <div class="events-item">
                    <div class="event-thumb">
                        <img src="gopali-img/akolaevent.jpg" style="height: 400px;">
                    </div>
                    <div class="event-details">
                        <strong>LiGHT Akola Event</strong>
    ...
    <section class="gallery-section bg-grey bd-bottom padding">
        ...
        <div class="row">
            ...
            $result = mysqli_query($conn, "SELECT * FROM gallery LIMIT 6");
