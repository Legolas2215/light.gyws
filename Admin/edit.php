...
if (isset($_POST['update'])) {
  ...
  $update = "UPDATE `add_members` SET `First Name`='$first_name',`Last Name`='$last_name',`Member ID`='$member_id',`DOB`='$dob',`phone`='$phone',`Email`='$email',`Address`='$address',`City`='$city',`State`='$state',`Year Of Joining`='$year_of_joining',`Post/ Desgination`='$postd',`image`='$image', `CentreBranch` = '$centre' WHERE id = '$id'";
                ...
                <form method="POST" action="#" enctype="multipart/form-data">
                  <div class="card-body">
                    ...
                    <div class="custom-file">
                      ...
                      <span>
                        <td><img src="../Admin/Initiative_image/<?php echo $image ?>" height="80" width="100" /></td>
                      </span>
                    </div>
