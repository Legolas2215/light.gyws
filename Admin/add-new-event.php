 ...
 <body class="hold-transition sidebar-mini">
   ...
   <?php
    ...
    if (isset($_POST['upload'])) {
      ...
      $sql = "INSERT INTO `initiative`(`first_title`,`text1`,`text2`, `secound_title`, `branchs`,`catagury`, `image`) VALUES ('$first_title','$text1','$text2','$secound_title','$branchs','$catagury','$image')";
      // Execute query
